    ...
    return (
        <div className="faq-area pt-120 pb-120">
            <div className="container">
                <div className="faq-wrapper wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div className="gm-faq-group">
                                <div className="accordion-item">
                                    ...
                                    <div id="collapseOne" className="accordion-collapse collapse" aria-labelledby="headingOne"
                                        ...
                                        Our commitment to excellence drives us to provide the finest mulch products, carefully curated to suit your specific needs. Whether you're aiming for a vibrant burst of color or seeking a natural look, we have mulch varieties that cater to your preferences. 
                                        </div>
                                    </div>
                                </div>
                                <div className="accordion-item">
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingFive">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            What does partial sun/partial shade?
                                        </button>
                                    </h2>
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingSix">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            Wait for Garden Proposal Decisions?
                                        </button>
                                    </h2>
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingTen">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            Eco-gardening is the practise of gardening?
                                        </button>
                                    </h2>
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingEleven">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            Why garden is important in our life?
                                        </button>
                                    </h2>
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingTwelve">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            Permaculture gardens use techniques?
                                        </button>
                                    </h2>
