                        ...
                        <nav>
                            <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                <div className="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1"
                                    role="tab" aria-controls="nav-1" aria-selected="true"><span className="tab-number">01</span>Residential<i className="flaticon-home"></i></div>
                                <div className="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" role="tab"
                                    ...
                                    <i className="flaticon-working"></i></div>
                            </div>
                        </nav>
                    </div>
                                ...
                                <div className="about-service-wrapper">
                                    ...
                                    <div className="row gx-0 align-items-center">
                                        <div className="col-lg-6">
                                            <div className="service-tab-content">
                                                <div className="section-title style-3">
                                                    <span className="section-subtitle">Available in bulk</span>
                                                    <h2 className="section-main-title mb-20">Royal Mulch offers a full-service</h2>
                                                </div>
